  ...
  en: {
    translation: {
      ...
      smartPlan: {
        ...
        syncing: "Syncing with Amadeus Live Feed...",
        step1Title: "Where does your journey begin?",
        step1Subtitle: "Live flight & hotel availability for Maldives (MLE)",
        originLabel: "Origin City",
        originPlaceholder: "e.g. London, Dubai, Singapore",
        travelersLabel: "Travelers",
        departureLabel: "Departure",
        returnLabel: "Return",
        searchBtn: "Search Live Offers",
        step2Title: "Select Your Flight",
        changeSearch: "Change Search",
        stops: "Stop(s)",
        totalFor: "Total for {{count}} Adults",
        continueHotels: "Continue to Hotels",
        step3Title: "Select Your Sanctuary",
        backFlights: "Back to Flights",
        perNight: "Per Night",
        totalStay: "Total Stay",
        continueExperiences: "Continue to Experiences",
        step4Title: "Curate Your Experiences",
        backHotels: "Back to Hotels",
        reviewPackage: "Review Your Package",
        step5Title: "Your Bespoke Journey",
        flightDetails: "Flight Details",
        sanctuary: "Sanctuary",
        experiences: "Experiences",
        noActivities: "No activities selected",
        estimatedTotal: "Estimated Package Total",
        taxesFees: "Includes all taxes and luxury concierge fees",
        confirmFinalize: "Confirm & Finalize",
        modifySelections: "Modify Selections",
        step6Title: "Secure Your Serenity",
        step6Subtitle: "Provide your details to receive the full itinerary",
        fullName: "Full Name",
        emailAddress: "Email Address",
        phoneNumber: "Phone Number",
        sendItinerary: "Send My Itinerary",
        processing: "Processing...",
        successTitle: "Itinerary Sent.",
        successDesc: "Your bespoke Maldivian package has been sent to {{email}}. Our luxury concierge will contact you within 2 hours to finalize your booking.",
        returnHome: "Return to Serenity"
      },
      seo: {
