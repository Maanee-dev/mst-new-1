...
const Terms: React.FC = () => {
  return (
    <div className="bg-[#FCFAF7] dark:bg-slate-950 min-h-screen pb-32 transition-colors duration-300">
      ...
      <section className="max-w-3xl mx-auto px-6 prose prose-slate prose-lg dark:prose-invert -mt-16 relative z-20">
        <div className="bg-white dark:bg-slate-900 rounded-[3rem] p-12 md:p-20 shadow-2xl border border-slate-50 dark:border-white/5 transition-colors duration-300">
          <h2 className="font-serif italic text-3xl mb-8 text-slate-900 dark:text-white">1. The Contract</h2>
          <p className="text-slate-600 dark:text-slate-400 leading-loose text-sm mb-12">
          ...
          <h2 className="font-serif italic text-3xl mb-8 text-slate-900 dark:text-white">2. Booking & Confirmation</h2>
          <p className="text-slate-600 dark:text-slate-400 leading-loose text-sm mb-12">
          ...
          <h2 className="font-serif italic text-3xl mb-8 text-slate-900 dark:text-white">3. Cancellations & Alterations</h2>
          <p className="text-slate-600 dark:text-slate-400 leading-loose text-sm mb-12">
          ...
          <h2 className="font-serif italic text-3xl mb-8 text-slate-900 dark:text-white">4. Logistics & Transfers</h2>
          <p className="text-slate-600 dark:text-slate-400 leading-loose text-sm mb-12">
          ...
          <h2 className="font-serif italic text-3xl mb-8 text-slate-900 dark:text-white">5. Governing Law</h2>
          <p className="text-slate-600 dark:text-slate-400 leading-loose text-sm">
